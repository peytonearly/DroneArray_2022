function dVdt = AircraftEOM(var, g, m, nu, mu, k, I) %keep function name
    % Inputs:
    ...
    angVelDot = [(Iy-Iz)*q*r/Ix; (Iz-Ix)*p*r/Iy; (Ix-Iy)*p*q/Iz] + [L/Ix; M/Iy; N/Iz] + [Lc/Ix; Mc/Iy; Nc/Iz];
